...
# Load YOLO model
model = YOLO("./best.pt")  # Ensure correct path

# Define calories for each class
calorie_dict = {
    "Chapati": 190, "Chicken Tandoor": 230, "Chole": 280, "Fish Fry": 250,
    "Gajar Halwa": 360, "Gulab Jamun": 430, "Jalebi": 400, "Jeera Rice": 200,
    "Matar Paneer": 365, "Modak": 320, "Paneer Masala": 350, "Panipuri": 180,
    "Prawn Masala": 210, "Pulav": 250, "Samosa": 308, "Vadapav": 290,
}
